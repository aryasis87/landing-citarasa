  ...
  return (
    ...
    >
      <div className="container mx-auto flex items-center justify-between p-4">
        ...
        {/* Desktop Navigation */}
        <nav className="hidden md:flex space-x-6 lg:space-x-8 text-cream text-xl">
          <Link href="#company" className="hover:text-enamel transition">
            About
          </Link>
          <Link href="#leadform" className="hover:text-enamel transition">
            Contact
          </Link>
        </nav>
        {/* Mobile Menu Button */}
      ...
      <AnimatePresence>
        {isMenuOpen && (
          ...
          >
            <ul className="flex flex-col text-soot-soft text-lg items-center space-y-4 p-4">
              <li>
                <Link
                  href="#company"
                  onClick={() => setIsMenuOpen(false)}
                  className="block hover:text-enamel transition"
                >
                  About
                </Link>
              </li>
